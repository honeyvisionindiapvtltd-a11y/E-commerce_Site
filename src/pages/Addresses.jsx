...
export default function Addresses() {
  const { profile, addresses, addAddress, removeAddress, setDefaultAddress } = useCommerce();
          ...
          <aside className="rounded-3xl border border-gray-200 bg-white p-6 shadow-sm">
            ...
            <div className="mt-6 space-y-4">
              ...
              <div className="rounded-2xl bg-[#F9FAFB] p-4">
                ...
                <p className="mt-2 text-lg font-bold text-[#071426]">{addresses.find((addr) => addr.isDefault)?.city || profile.city || "Bhubaneswar"}, {addresses.find((addr) => addr.isDefault)?.state || profile.state || "Odisha"}</p>
              </div>
              <div className="rounded-2xl bg-[#F9FAFB] p-4">
