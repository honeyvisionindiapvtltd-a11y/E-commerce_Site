...
const EditProfile = () => {
  ...
  const handleSubmit = (event) => {
    ...
    updateProfile({
      ...formData,
      location: `${formData.city || "Bhubaneswar"}, ${formData.state || "Odisha"}`,
    });
    navigate("/profile");
  };
            ...
            <div className="rounded-2xl border border-gray-100 bg-white p-6 shadow-sm md:p-8">
              <div className="flex flex-col gap-5 md:flex-row md:items-center md:justify-between">
                ...
                <div className="flex flex-col gap-3 sm:flex-row">
                  ...
                  <button type="submit" className="inline-flex items-center justify-center gap-2 rounded-xl bg-[#F4B400] px-7 py-3 font-bold text-[#071426] shadow-sm transition hover:bg-[#E5A900] hover:shadow-md">
                    <Save size={19} />
                    Save Changes
                  </button>
                </div>
