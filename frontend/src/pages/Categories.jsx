...
const categoryImageFallback = "https://res.cloudinary.com/vhrkwyzs/image/upload/v1786165545/Dahua_4MP_AI_Dome_Camera_aqg3co.png";
    ...
    const loadCategories = async () => {
      try {
        ...
        const nextTiles = trees.map((category) => ({
          ...
          slug: category.slug || "",
          src: category.src || category.image || "",
          image: category.src || category.image || "",
        ...
        if (isMounted) { setCategoryTiles([]); setError(error.message || "Unable to load categories from MongoDB."); }
      } finally {
      ...
      <section className="relative overflow-hidden bg-[#061a38]">
        ...
        <div className="relative mx-auto max-w-7xl px-4 py-14 sm:px-6 lg:px-8">
          ...
          <div className="grid items-center gap-10 lg:grid-cols-[1fr_420px]">
            {error && <div className="rounded-lg border border-red-300 bg-red-50 px-4 py-3 text-sm text-red-700 lg:col-span-2">{error}</div>}
            {/* Hero Content */}
            <div>
            ...
            <div className="relative hidden lg:block">
              <div className="absolute inset-0 rounded-4xl bg-amber-400/10 blur-3xl" />

              <div className="relative overflow-hidden rounded-4xl border border-white/10 bg-white/5 p-6 backdrop-blur-sm">
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="col-span-2 rounded-2xl border border-amber-400/20 bg-linear-to-r from-amber-400/10 to-transparent p-5">
        ...
        <div className="h-1 bg-linear-to-r from-transparent via-amber-400 to-transparent" />
      </section>
        ...
        <div className="grid gap-8 lg:grid-cols-[250px_1fr]">
          ...
          <aside className="hidden lg:block">
            <div className="sticky top-24 overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
              ...
              {/* Support */}
              <div className="m-3 rounded-2xl bg-linear-to-br from-[#061a38] to-[#0b315f] p-5 text-white">
                      ...
                      >
                        {src ? (
                          <img
                            src={src}
                            alt={name}
                            onError={(event) => { event.currentTarget.onerror = null; event.currentTarget.src = categoryImageFallback; }}
                            className="h-full w-full object-cover transition duration-500 group-hover:scale-105"
                          />
                        ) : null}

                        {/* Overlay */}
                        <div className="absolute inset-0 bg-linear-to-t from-[#061a38]/50 via-transparent to-transparent opacity-60" />
