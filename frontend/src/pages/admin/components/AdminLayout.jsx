  ...
  return <div className="admin-shell min-h-screen bg-slate-50 text-slate-900">
    ...
    <div className="lg:pl-[235px] min-h-screen">
      <header className="sticky top-0 z-30 flex h-16 items-center justify-between border-b border-slate-200 bg-white px-4 shadow-sm sm:px-6">
        <div className="flex items-center gap-3"><button className="rounded-lg p-2 hover:bg-slate-100 lg:hidden" onClick={()=>setOpen(true)}><Menu size={20}/></button><h1 className="text-lg font-semibold">{activeTitle}</h1><button type="button" onClick={() => navigate("/")} className="rounded-lg p-2 text-slate-500 hover:bg-slate-100 hover:text-slate-900" aria-label="Go to home" title="Go to home"><Home size={18}/></button></div>
