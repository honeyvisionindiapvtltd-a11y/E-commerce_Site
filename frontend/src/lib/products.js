...
const categoryImageMap = {
  "cctv-cameras": "https://res.cloudinary.com/vhrkwyzs/image/upload/v1786010027/cctv_y2raii.jpg",
  "nvr-and-dvr": "https://res.cloudinary.com/vhrkwyzs/image/upload/v1786165545/Dahua_4MP_AI_Dome_Camera_aqg3co.png",
  "led-displays": "https://res.cloudinary.com/vhrkwyzs/image/upload/v1786010024/display_rar3xa.webp",
  "computer-accessories": "https://res.cloudinary.com/vhrkwyzs/image/upload/v1786012476/headphone_ami4sj.webp",
  "printers-and-scanners": "https://res.cloudinary.com/vhrkwyzs/image/upload/v1786010025/officeeqp0.124_voj31y.jpg",
  "networking-products": "https://res.cloudinary.com/vhrkwyzs/image/upload/v1786010023/networking_ozm2kk.jpg",
  "storage-and-hard-drives": "https://res.cloudinary.com/vhrkwyzs/image/upload/v1786010026/components_hlmuj1.jpg",
  "power-backup": "https://res.cloudinary.com/vhrkwyzs/image/upload/v1786010026/power_bank_kqypks.jpg",
  "drones-and-cameras": "https://res.cloudinary.com/vhrkwyzs/image/upload/v1786010025/drones_lcgqbs.jpg",
  "office-equipment": "https://res.cloudinary.com/vhrkwyzs/image/upload/v1786010025/officeeqp0.124_voj31y.jpg",
  "it-accessories": "https://res.cloudinary.com/vhrkwyzs/image/upload/v1786012476/headphone_ami4sj.webp",
};

const defaultCatalogImage =
  "https://res.cloudinary.com/vhrkwyzs/image/upload/v1786010029/laptop_ktvxcs.png";

export const categoryImageFor = (category = "") => {
  ...
  if (label.includes("cctv") || label.includes("camera")) return categoryImageMap["cctv-cameras"];
  if (label.includes("nvr") || label.includes("dvr")) return categoryImageMap["nvr-and-dvr"];
  if (label.includes("display") || label.includes("monitor") || label.includes("led")) return categoryImageMap["led-displays"];
  if (label.includes("network")) return categoryImageMap["networking-products"];
  if (label.includes("power") || label.includes("ups") || label.includes("backup")) return categoryImageMap["power-backup"];
  if (label.includes("printer") || label.includes("office")) return categoryImageMap["printers-and-scanners"];
  if (label.includes("accessor") || label.includes("computer")) return categoryImageMap["computer-accessories"];
  return defaultCatalogImage;
};

const isUsableImage = (value) =>
  typeof value === "string" && value.trim() && !value.startsWith("/images/products/");
...
export const normalizeProduct = (product) => {
  ...
  return {
    ...
    image: [product.src, product.thumbnail, product.image, product.images?.[0]].find(isUsableImage) || categoryImageFor(category),
